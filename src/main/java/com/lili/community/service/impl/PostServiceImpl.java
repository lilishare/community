...
import com.lili.community.mapper.*;
...
import com.lili.community.model.entity.*;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public PostVO getPostVO(Post post, HttpServletRequest request) {
        ...
        commentQueryRequest.setId(postId);
        Page<CommentVo> commentVOPage = commentService.getCommentVOPage(commentQueryRequest, request);
        postVO.setCommentList(commentVOPage);
        return postVO;
    }
