...
public interface UserService extends IService<User> {
     ...
     * @return 新用户 id
     */
    Map<String,Object> userRegister(String userAccount, String userPassword, String checkPassword, String email, Model model);
     ...
     * @return
     */
    int  activation(Long userId, String activationCode) ;
